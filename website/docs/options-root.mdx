...
| ------------------------------------- | -------- | -------- |
| [BottomTabOptions](bottomTab-options.mdx) | No       | Both     |
...
| Type                                    | Required | Platform |
| --------------------------------------- | -------- | -------- |
| [BottomTabsOptions](bottomTabs-options.mdx) | No       | Both     |
...
| Type                                | Required | Platform |
| ----------------------------------- | -------- | -------- |
| [SideMenuOptions](sideMenu-options.mdx) | No       | Both     |

## `overlay`

| Type                              | Required | Platform |
| --------------------------------- | -------- | -------- |
| [OverlayOptions](overlay-options.mdx) | No       | Both     |

## `animations`

| Type                                    | Required | Platform |
| --------------------------------------- | -------- | -------- |
| [AnimationsOptions](animations-options.mdx) | No       | Both     |

## `modal`

| Type                          | Required | Platform |
| ----------------------------- | -------- | -------- |
| [ModalOptions](modal-options.mdx) | No       | Both     |
...
| Type                                  | Required | Platform |
| ------------------------------------- | -------- | -------- |
| [SplitViewOptions](splitView-options.mdx) | No       | iOS      |
