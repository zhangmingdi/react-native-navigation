...
| ------ | -------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| layout | Yes      | [Layout](Layout.mdx) | Any type of layout. [BottomTabs](bottomTabs-layout.mdx), [Stack](stack-layout.mdx), [SideMenu](sideMenu-layout.mdx), [Component](component-layout.mdx) |
