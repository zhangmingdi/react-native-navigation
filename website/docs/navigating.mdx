...
We've also learned of a few methods to apply styles to our screens and layouts with the Options mechanism.
...
* Themes are applied with the `Navigation.setDefaultOptions()` command.
