...
TODO:
- The `:::caution ..... :::` section speaks about future plans - is there a related issue people could track (because that would be cool)?
- starting from Shared element transitions, things get **very** confusing, maybe we need to add more visual examples or move things around or correct H1, H2, H3, etc. hierarchy.

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';
import useBaseUrl from '@docusaurus/useBaseUrl';

Our animation framework allows you to animate various elements in your UI by declaring animation options.
...
Four elements are animated in the example above:
...
* **title** - the item title is animated to the next screen.
  * font size
  * font color
  * position on screen

* **Description** - the item description in the destination screen.
  * fade-in
  * translation y

### Recreating transitions on your own
...
## Element Transitions
Besides being stand-alone, element transitions also allow you to animate elements during shared element transitions.
