...
Lets take a more in-depth look at the following example, which you can find in the playground app:
...
Four elements are animated in this example. Lets list the elements involved in the transition and note which properties are being animated.
