---
id: screen-animations
title: Screen Animations
sidebar_label: Screen Animations
---
...
The following properties can be animated with our animation framwork:

* **x** - Translate the view to a coordinate along the x axis.
* **y** - Translate the view to a coordinate along the y axis.
* **translationX** - Translates the view along the x axis relative to its current x position.
* **translationY** - Translates the view along the y axis relative to its current y position.
* **alpha** - Applies alpha animation on the view. A value of 0 means the view is not visible, 1 means it's visible.
...
* **rotationX** - Applies a rotation around the x axis.
* **rotationY** - Applies a rotation around the y axis.
* **rotation** - Rotates the view on all axis. Positive values result in clockwise rotation.

## Stack animations
When animating screens in and out of a stack, you can animate three elements

1. **content** - the screen being pushed or popped
2. **topBar** - the stack's TopBar
3. **bottomTabs** - If the stack is a child of a bottomTabs layout, we can control the hide and show animations of the bottomTabs
...
The following example demonstrates how to declare a slide-in animation for pushed screens.
...
The following example demonstrates how to declare a side-out animation for popped screens.
...
## Modal animations
Modal animations are declared similarly to stack animations, only this time we animte the entire view and not only
part of the UI (content).
