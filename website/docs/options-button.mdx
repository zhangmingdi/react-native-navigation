...
Set a react [component](component-layout.mdx) as this button's view which will be displayed instead of the regular view.

| Type                   | Required | Platform |
| ---------------------- | -------- | -------- |
| [Component](component-layout.mdx) | No       | Both     |

### `iconInsets`

[IconInsets](iconInsets-options.mdx) are applied to the icon to translate its original position on the screen.
