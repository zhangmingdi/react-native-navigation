...
### Registering the ViewController
...
```
### Using the ViewController from JS
Once you've registered the external ViewController in native, you can use it in your layout declarations.
For example, to show an external component modally:
```js
Navigation.showModal({
  externalComponent: {
