...
| concreteComponentProvider | No      | Function | Anonymous function which returns the concrete react component. If your component is wrapped with Providers, this must an instance of the concrete component|
