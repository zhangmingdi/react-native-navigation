...
| Type                         | Required | Platform |
| ---------------------------- | -------- | -------- |
| [Subitle](#subtitle-options) | No       | Both     |
...
| Type                              | Required | Platform |
| --------------------------------- | -------- | -------- |
| [BackButton](#backButton-options) | No       | Both     |
...
| Type                              | Required | Platform |
| --------------------------------- | -------- | -------- |
| [Background](#background-options) | No       | Both     |
...
An array of buttons to be displayed at the right side of the TopBar. Buttons are layed out in order from left to right. See the [Buttons](button-options) section for more details.

?> Android currently only supports a single left button and does not support custom left Buttons

| Type                           | Required | Platform |
| ------------------------------ | -------- | -------- |
| [[Button]](button-options) | No       | Both     |
...
An array of buttons to be displayed at the right side of the TopBar. Buttons are layed out in order from right to left. See the [Buttons](button-options) section for more details.
