...
A common use case when using SideMenus is to interact with the center layout e.g. pushing a screen to a stack in the center layout when user clicks on a button in one of the menus.
