...
Bottom tabs referees to a row of links, displayed at the bottom of the screen, and is refereed to as "Tab Bar" in iOS and as "Bottom Navigation Bars" on Android. Usually these are intended to be used to switch between top-level content views with a single tap.
